...
Além do atraso quanto ao avanço do capitalismo, principalmente em comparação com a Inglaterra, havia também os gastos elevados e desnecessários do governo francês nessa época. Um grande exemplo foi o envolvimento da França na Revolução Americana, o que causou um grande impacto na economia francesa.
...
Segundo o historiador Hobsbawm, o Estado francês gastava cerca de 20% a mais do que deveria, usava 50% do seu orçamento para pagar dívidas, e a inflação crescia rapidamente. Tamanha crise econômica demandava reformas, mas, como mencionado, nobreza e clero não estavam dispostos a abrir mão de seus privilégios.

Em 1788, as colheitas na França haviam sido ruins, o que aumentou consideravelmente o custo de vida tanto no campo quanto nas cidades. Logo, em 1789, a França já se encontrava em estado avançado de convulsão social. O efeito disso foi que a crise instalada nesse momento empurrou as pessoas para a rebelião e para o banditismo. A fim de contornar esse cenário, os Estados Gerais foram convocados.
''', 
    ),
    ...
    Aderecos(
      urlImage: 'https://media.gettyimages.com/id/1326286817/pt/foto/the-battle-of-wagram-1809-1938-napoleon-bonaparte-defeated-the-austrians-at-wagram-forcing.jpg?s=1024x1024&w=gi&k=20&c=hAuQzdBSGC8BE5iBxNHx9IWLjkHDiysoMTw2KfTlIqM=',
      titulo: 'Era Napoleônica',
      descricao: 'O legado do general girondino',
      textoCompleto: '''Após a morte do rei Luís XVI (1754-1793), durante a Revolução Francesa, as nações europeias temeram que os ideais revolucionários se espalhassem.
...
Em meio à guerra, os jacobinos prenderam os líderes girondinos, promulgaram a nova Constituição de 1793, inciando o período conhecido como Terror, com a suspensão dos direitos individuais e execuções sumárias.

A situação na França ainda assustava os líderes europeus, que decidiram formar, em 1798, a Segunda Coligação antifrancesa, formada pela Grã-Bretanha, Áustria e Rússia. É neste contexto que Napoleão Bonaparte é visto como solução pelos vários setores da burguesia.

Podemos dividir a Era Napoleônica nas seguintes fases:

- Consulado 
- Império Napoleônico 
- Governo dos Cem Dias

Quanto ao Golpe do 18 de Brumário e Consulado:
...
O trio coordenou a elaboração de uma nova Constituição que estabelecia Napoleão como primeiro-cônsul pelo prazo de dez anos. A Carta Magna ainda lhe concedia poderes de ditador.''', // Outro exemplo
    ),
  ];
}
